var LanguageJs = LanguageJs || {};

LanguageJs.createNameSpace = function (namespace) {

    //get the namespace string and split it
    var namespaceArr = namespace.split('.');
    var parent = LanguageJs;

    // excluding the parent
    if (namespaceArr[0] === 'LanguageJs') {
...
LanguageJs.createNameSpace("LanguageJs.Cookies");

LanguageJs.Cookies.getCookie = function (ck_name) {
...
LanguageJs.Cookies.setCookie = function (ck_name, value, exdays) {
    var exdate = new Date();
